...
5. **Report back.** Give **project-manager** what it asked for under **Report back to me with**, so it can update the pipeline. If the pipeline changed, sync the HQ page as described in `CLAUDE.md`.
6. **Tell me**, briefly:
